...
import static ru.javarush.november.timberg.island.living_objects.animals.AnimalType.*;
 ...
 public class Config {
    ...
    public static final Map<AnimalType, Integer> BOAR_EATING_MAP = Map.ofEntries(
            Map.entry(MOUSE, 50),
    ...
    public static final Map<AnimalType, Integer> BUFFALO_EATING_MAP = Map.ofEntries(
            Map.entry(AnimalType.PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> CATERPILLAR_EATING_MAP = Map.ofEntries(
            Map.entry(AnimalType.PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> DEER_EATING_MAP = Map.ofEntries(
            Map.entry(PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> DUCK_EATING_MAP = Map.ofEntries(
            Map.entry(AnimalType.CATERPILLAR, 90),
            Map.entry(AnimalType.PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> GOAT_EATING_MAP = Map.ofEntries(
            Map.entry(PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> HORSE_EATING_MAP = Map.ofEntries(
            Map.entry(PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> MOUSE_EATING_MAP = Map.ofEntries(
            Map.entry(CATERPILLAR, 90),
            Map.entry(PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> RABBIT_EATING_MAP = Map.ofEntries(
            Map.entry(PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> SHEEP_EATING_MAP = Map.ofEntries(
            Map.entry(PLANTS, 100)
    );
    ...
    public static final Map<AnimalType, Integer> BEAR_EATING_MAP = Map.ofEntries(
            Map.entry(AnimalType.BOA, 80),
            Map.entry(AnimalType.HORSE, 40),
            Map.entry(AnimalType.DEER, 80),
            Map.entry(AnimalType.RABBIT, 80),
            Map.entry(AnimalType.MOUSE, 90),
            Map.entry(AnimalType.GOAT, 70),
            Map.entry(AnimalType.SHEEP, 70),
            Map.entry(AnimalType.BOAR, 50),
            Map.entry(AnimalType.BUFFALO, 20),
            Map.entry(AnimalType.DUCK, 10)
    );
    ...
    public static final Map<AnimalType, Integer> BOA_EATING_MAP = Map.ofEntries(
            Map.entry(AnimalType.FOX, 15),
            Map.entry(AnimalType.RABBIT, 20),
            Map.entry(AnimalType.MOUSE, 40),
            Map.entry(AnimalType.DUCK, 10)
    );
    ...
    public static final Map<AnimalType, Integer> EAGLE_EATING_MAP = Map.ofEntries(
            Map.entry(FOX, 10),
            Map.entry(RABBIT, 90),
            Map.entry(MOUSE, 90),
            Map.entry(DUCK, 80)
    ...
    public static final Map<AnimalType, Integer> FOX_EATING_MAP = Map.ofEntries(
            Map.entry(RABBIT, 70),
            Map.entry(MOUSE, 90),
            Map.entry(DUCK, 60),
    ...
    public static final Map<AnimalType, Integer> WOLF_EATING_MAP = Map.ofEntries(
            Map.entry(AnimalType.HORSE, 10),
            Map.entry(AnimalType.DEER, 15),
            Map.entry(AnimalType.RABBIT, 60),
            Map.entry(AnimalType.MOUSE, 80),
            Map.entry(AnimalType.GOAT, 60),
            Map.entry(AnimalType.SHEEP, 70),
            Map.entry(AnimalType.BOAR, 15),
            Map.entry(AnimalType.BUFFALO, 10),
            Map.entry(AnimalType.DUCK, 40)
    );
