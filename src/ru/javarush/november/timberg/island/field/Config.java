...
public class Config {
    ...
    public static final double BOAR_SATURATION = 50;
    ...
    public static final double BUFFALO_SATURATION = 100;
    ...
    public static final double CATERPILLAR_SATURATION = 0;
    ...
    public static final double DEER_SATURATION = 50;
    ...
    public static final double DUCK_SATURATION = 0.15;
    ...
    public static final double GOAT_SATURATION = 10;
    ...
    public static final double HORSE_SATURATION = 50;
    ...
    public static final double MOUSE_SATURATION = 0.01;
    ...
    public static final double RABBIT_SATURATION = 0.45;
    ...
    public static final double SHEEP_SATURATION = 15;
    ...
    public static final double BEAR_SATURATION = 80;
    ...
    public static final double BOA_SATURATION = 3;
    ...
    public static final double EAGLE_SATURATION = 1;
    ...
    public static final double FOX_SATURATION = 2;
    ...
    public static final double WOLF_SATURATION = 8;
    ...
    public static final double PLANTS_SATURATION = 0;
